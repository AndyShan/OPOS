 ...
 */
public class MyImageButton3 extends FrameLayout{
    private TextView mTextView;
    private FrameLayout frameLayout;
    private Context mContext;
    private ImageView imageView;
    public MyImageButton3(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.layout_image_button3, this, true);
        mContext = context;
